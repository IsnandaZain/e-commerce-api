...
from myshop.exceptions import MyShopException
...
def handle_bad_signature(e):
    ...
    tampil = {
        "status": 401,
        "message": ("Your token signature is broken,"
...
@bp.app_errorhandler(MyShopException)
def handle_invalid_usage(e):
    """Will be execute if MyShopException or child raised
