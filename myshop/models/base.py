...
class MyShopBaseQuery(BaseQuery):
...
class MyShopModel(Model):
    # Change query class with SoccerBaseQuery
    query_class = MyShopBaseQuery


class MyShopDB(SQLAlchemy):
    ...
    def make_declarative_base(self, model, metadata=None):
        ...
        base = declarative_base(cls=MyShopModel, name='Model',
                                metadata=metadata,
